...
class MainWindow(QWidget):
    ...
    def process(self):
        ...
        if self.curr_path.suffix == '.h5':
            ...
            jobs = self.read_txt(is_file, folder, num_files, folder_name)
        
        self.start_evaluation(jobs)
    ...
    def on_eval_finished(self, results):
        ...
        for r in results:
            key = r["file_key"]
            num = r["file_num"]
            self.file_list.setdefault(key, {})[num] = r["res"]
    ...
    def read_txt(self, is_file, folder, num_files, folder_name):
        ...
        self.total_profs_num = num_files - 1 if prof_id == "None" else 0
        self.progress_bar.setMaximum(self.total_profs_num)
        self.progress_bar.setParent(self.scroll_area.parentWidget())
        ...
        while i < num_files:
            ...
            if prof_id == "None":
                ...
                self.total_profs_num += num_ids
                self.progress_bar.setMaximum(self.total_profs_num)

                id_idx = 0
                while id_idx < num_ids:
    ...
    def show_file_selector(self):
        ...
        self.main_area_layout.insertWidget(0, self.progress_bar)
        self.progress_bar.show()
    ...
    def build_profile_view(self, file_index, profile_index, flag=False):
        ...
        fig, df, u, losses = profile['fig'], profile['table'], profile['uncert'], profile['losses']
